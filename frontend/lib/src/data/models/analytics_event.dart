...
String analyticsEventNameToJson(AnalyticsEventName name) {
  return switch (name) {
    ...
    AnalyticsEventName.frontendFrameSummary => 'frontend.frame_summary',
    ...
    AnalyticsEventName.connectionRouteChanged => 'connection.route_changed',
