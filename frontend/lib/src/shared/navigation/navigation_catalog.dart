  ...
  return [
    ...
    NavCatalogGroup(
      ...
      entries: [
        ...
        NavCatalogEntry(
          destination: AppNavigationDestination.conversations,
          icon: Icons.forum_outlined,
          selectedIcon: Icons.forum,
          label: l10n.conversationsDrawerLabel,
          keywords: const [
            'conversations',
            'messages',
            'sms',
        ...
        NavCatalogEntry(
          destination: AppNavigationDestination.campaigns,
          icon: Icons.campaign_outlined,
          selectedIcon: Icons.campaign,
          label: l10n.campaignsDrawerLabel,
          keywords: const [
            'campaigns',
            'marketing',
            'promo',
