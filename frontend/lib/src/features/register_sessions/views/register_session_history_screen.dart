    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        return Scaffold(
          ...
          body: SafeArea(child: _HistoryWorkspace(viewModel: viewModel)),
        );
      },
    );
  }
...
class _HistoryWorkspace extends StatelessWidget {
  const _HistoryWorkspace({required this.viewModel});
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final sessions = RegisterSessionList(viewModel: viewModel);
        final orders = SessionOrders(viewModel: viewModel);
