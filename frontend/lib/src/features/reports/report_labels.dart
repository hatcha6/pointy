...
const _notes = {
  ...
  'payroll_period_overlap':
      'يُحتسب أي مسير تتقاطع فترته مع فترة التقرير.',
  ...
  'staff_is_register_owner': 'يُنسب البيع إلى صاحب جلسة الدرج التي حُرِّر عليها.',
  ...
  'aged_from_invoice_date':
      'حُسبت الأعمار من تاريخ الفاتورة، إذ لا يوجد تاريخ استحقاق متفق عليه '
      'مسجَّل للفواتير الآجلة.',
  ...
  'purchase_is_stock_not_expense': 'المشتريات تُضاف إلى المخزون ولا تُعد مصروفًا.',
  ...
  // -- reorder --------------------------------------------------------------
  'reorder_target_is_twice_level': 'الكمية المقترحة تُعيد المخزون إلى ضعف حد الطلب.',
  'reorder_counts_incoming': 'تُخصم الكميات الواردة في الطريق حتى لا يتكرر الطلب.',

  // -- the period itself ----------------------------------------------------
  'period_open':
      'الفترة ما زالت مفتوحة: قد تتغير هذه الأرقام إن سُجّلت حركات لاحقة '
      'بتاريخ يقع داخلها.',
  'period_closed': 'الدفاتر مقفلة حتى {date}؛ أرقام هذه الفترة لا يمكن أن تتغير.',
