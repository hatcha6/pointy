...
const P: Record<string, string> = {
  ...
  camera: 'M3.5 8.2A1.7 1.7 0 0 1 5.2 6.5h9.1a1.7 1.7 0 0 1 1.7 1.7v7.6a1.7 1.7 0 0 1-1.7 1.7H5.2a1.7 1.7 0 0 1-1.7-1.7V8.2ZM16 10.6l4.5-2.7v8.2L16 13.4',
  grid: 'M4 4.8A.8.8 0 0 1 4.8 4h4.4a.8.8 0 0 1 .8.8v4.4a.8.8 0 0 1-.8.8H4.8a.8.8 0 0 1-.8-.8V4.8ZM14 4.8a.8.8 0 0 1 .8-.8h4.4a.8.8 0 0 1 .8.8v4.4a.8.8 0 0 1-.8.8h-4.4a.8.8 0 0 1-.8-.8V4.8ZM4 14.8a.8.8 0 0 1 .8-.8h4.4a.8.8 0 0 1 .8.8v4.4a.8.8 0 0 1-.8.8H4.8a.8.8 0 0 1-.8-.8v-4.4ZM14 14.8a.8.8 0 0 1 .8-.8h4.4a.8.8 0 0 1 .8.8v4.4a.8.8 0 0 1-.8.8h-4.4a.8.8 0 0 1-.8-.8v-4.4Z',
  play: 'M8 5.2v13.6L19 12 8 5.2Z',
  download: 'M12 3.5v11.2M7.6 10.4 12 14.8l4.4-4.4M4.5 17.2v2.1a1.2 1.2 0 0 0 1.2 1.2h12.6a1.2 1.2 0 0 0 1.2-1.2v-2.1',
